...
export default function About() {
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-gray-50" aria-label="Visi dan Misi">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <RevealOnScroll>
              <article className="bg-white p-12 border border-gray-100 hover:border-gold hover:-translate-y-1 hover:shadow-xl transition-all duration-300 ease-in-out h-full rounded-2xl">
                <Target className="w-12 h-12 text-gold mb-6" aria-hidden="true" />
                <h2 className="font-heading text-2xl font-bold text-navy mb-4">Visi Kami</h2>
            ...
            <RevealOnScroll delay={0.2}>
              <article className="bg-white p-12 border border-gray-100 hover:border-gold hover:-translate-y-1 hover:shadow-xl transition-all duration-300 ease-in-out h-full rounded-2xl">
                <Award className="w-12 h-12 text-gold mb-6" aria-hidden="true" />
                <h2 className="font-heading text-2xl font-bold text-navy mb-4">Misi Kami</h2>
      ...
      {/* LEADERSHIP SECTION */}
      <section className="py-16 md:py-24 bg-white" aria-labelledby="leadership-heading">
        <div className="container mx-auto px-4">
          <RevealOnScroll>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-gold font-bold tracking-wider uppercase text-sm mb-4 block">Kepemimpinan</span>
              <h2 id="leadership-heading" className="font-heading text-4xl font-bold text-navy mb-6">Dewan Direksi Kami</h2>
              <p className="text-slate-600">Dipimpin oleh para profesional berpengalaman yang membawa visi strategis bagi perusahaan.</p>
            </div>
          </RevealOnScroll>
            ...
            {[
              ...
              <RevealOnScroll key={i} delay={i * 0.1}>
                <article className="group cursor-pointer">
                  <div className="relative aspect-[3/4] mb-6 overflow-hidden bg-gray-100 rounded-xl shadow-sm group-hover:shadow-lg transition-shadow duration-300">
                    <Image 
                      src={leader.img} 
                      alt={leader.name}
                      fill
